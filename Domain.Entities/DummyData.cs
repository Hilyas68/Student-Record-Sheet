...
namespace Web.Models
{
    public class DummyData
    {
        ...
        public static IEnumerable<Course> GetCourses() => new List<Course> { course1, course2, course3, course4, course5 };
        public static IEnumerable<Department> GetDepartments() => new List<Department> { dept1, dept2, dept3 };
        public static IEnumerable<Grade> GetGrades() => new List<Grade> { grade1, grade2, grade3, grade4, grade5, grade6 };
    }
}